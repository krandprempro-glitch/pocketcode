...
<p align="center">
  <strong>Android 上的 Claude Code 远程开发终端 | SSH SFTP 文件管理 | 移动端 AI 编程 IDE</strong>
</p>
...
> 在安卓手机上用 Claude Code 写代码、管理远程服务器文件、查看 Git 记录 —— 你的口袋开发工作站。支持 SSH 远程连接、SFTP 文件浏览、终端模拟器、剪贴板同步，是移动端 AI 辅助编程的理想工具。
